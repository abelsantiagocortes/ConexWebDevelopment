            ...
            <div className="contacto__form">
                ...
                <div className="contacto__formData">
                    <form action="" onSubmit={submitEmail}>
                        ...
                        <input onChange={(e) => setEmail(e.target.value)} required type="email" placeholder={t('Email.1')} name="" id="" />
                        <textarea value={input} onChange={(e) => setInput(e.target.value)} required rows="10" cols="50" placeholder={t('Yourquestions.1')} />
